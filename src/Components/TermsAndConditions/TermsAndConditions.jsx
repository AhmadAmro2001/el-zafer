  ...
  return <>
      <div className='container mx-auto relative px-4 md:px-36 md:mt-20 mt-24 text-white bg-[#095890]'>
        <div className='flex flex-col justify-center items-center  md:h-screen h-[250px] '>
            <h1 className='md:mb-5 md:text-6xl text-[24px] mb-3 font-bold'>Terms and conditions</h1>
            <h3 className='md:text-xl text-[10px] md:mb-2 '>By using our services, you acknowledge and agree to abide by the Terms and Conditions outlined below</h3>
            <p className='md:mt-5 md:text-lg text-[8px] text-center '>Which are designed to ensure a smooth and efficient shipping process for all our customers.</p>
        </div>
