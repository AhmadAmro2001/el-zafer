  ...
  return <>
      <div className="container mx-auto relative px-4 md:px-36 bg-[#095890]">
        <div className="flex flex-col justify-center items-center h-[200px] md:h-[682px]  text-white">
          <p className="md:mb-5 md:text-2xl text-[8px]">Terms and conditions</p>
          <h3 className="md:text-3xl text-[12px] md:mb-2">
          By using our services, you acknowledge and agree to abide by the Terms and Conditions outlined below
          </h3>
          <p className="md:mt-5 md:text-xl text-[8px]">
          Which are designed to ensure a smooth and efficient shipping process for all our customers.
          </p>
        </div>
