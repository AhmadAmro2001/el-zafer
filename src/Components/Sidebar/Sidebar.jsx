  ...
  return (
    <>
      ...
      {/* <button
        ...
        className={`fixed top-1/2 -translate-y-1/2 z-50 bg-white text-red-700 font-semibold px-3 py-2 rounded-r shadow-lg transition-all duration-300 ${
          isOpen ? 'left-28' : 'left-0'
        }`}
      >
        <i className={`fa-solid ${isOpen ? 'fa-chevron-left' : 'fa-chevron-right'}`} />
      </button> */}
